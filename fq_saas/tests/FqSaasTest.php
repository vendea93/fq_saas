...
class FqSaasTest
{
    ...
    {
        $this->CI = $CI;
        $this->CI->load->helper(FQ_SAAS_MODULE_NAME . '/' . FQ_SAAS_MODULE_NAME);
        $this->CI->load->helper(FQ_SAAS_MODULE_NAME . '/' . FQ_SAAS_MODULE_NAME . '_core');
        $this->CI->load->helper(FQ_SAAS_MODULE_NAME . '/' . FQ_SAAS_MODULE_NAME . '_setup');
